...
export const AppShell = ({ colorScheme, routes, title, navLinks }) => {
    ...
    return (_jsx(BrowserRouter, { children: _jsx(MantineProvider, Object.assign({ withGlobalStyles: true, withNormalizeCSS: true, theme: {
                colorScheme,
            } }, { children: _jsxs(MantineAppShell, Object.assign({ padding: "md", navbar: _jsx(Navbar, Object.assign({ width: { base: 300 }, height: 500, p: "xs" }, { children: navLinks.map((link) => (_createElement(MainLink, Object.assign({}, link, { key: link.path })))) })), header: _jsxs(Header, Object.assign({ height: 60, p: "xs", sx: { display: "flex" }, styles: (theme) => ({
                        main: {
                            backgroundColor: theme.colorScheme === "dark"
                                ? theme.colors.dark[8]
                                : theme.colors.gray[0],
